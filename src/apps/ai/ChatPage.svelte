<script>
  ...
  // ══════════════════════════════════════════════════════════════════════
  // WIDGETS NATIVOS DOM — versão completa
  // ══════════════════════════════════════════════════════════════════════
  ...
  function renderNativeMarket(container, json) {
    ...
    const TF={
      '1D':{days:1,points:96,vol:0.003},'1S':{days:7,points:168,vol:0.005},
      '1M':{days:30,points:120,vol:0.008},'3M':{days:90,points:90,vol:0.010},'1A':{days:365,points:120,vol:0.015}
    };
  ...
  function openApp(id) {
    activeApp = id; localStorage.setItem('nexa_active_app', id); showSheet = false; drawerOpen = false;
...
.bottom-bar {
  ...
  .app-card { display:flex; flex-direction:column; align-items:flex-start; gap:8px; padding:14px; border-radius:18px; border:1px solid; cursor:pointer; text-align:left; }

...
<style>
  /* Estrutura mantida igual, apenas os estilos dos botões foram adaptados */
  .bottom-bar {
    border-radius:22px;
  ...
  .bb-btn {
    ...
    border-radius: 999px; /* total curvatura, como o botão Atualizar */
    border: none;
    cursor:pointer; background: light-dark(#2a2a2a, #f5f5f5); /* cores temáticas */
    flex-shrink:0;
  ...
  /* O ícone dentro do botão fica branco/preto conforme o tema */
  .bb-btn .icon-mask {

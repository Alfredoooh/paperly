...
// partir de /icons/svg/apps/{id}.svg. A cor do CONTAINER circular é
// única para todos os apps e controlada pelo tema diretamente no CSS
// do CreateTab.svelte (azul Apple no claro, azul mais escuro no
// escuro) — por isso já não há campo `color` aqui.

...
{#if $currentTrack && !$playerOpen}
  <button class="mini" style="background:{bgCard};border:0.5px solid {divider}"
...
<style>
  .mini { position:absolute;left:12px;right:12px;bottom:calc(env(safe-area-inset-bottom,0px) + 56px + 12px);border-radius:16px;display:flex;align-items:center;gap:12px;padding:10px 12px;cursor:pointer;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);z-index:50;box-shadow:0 4px 24px rgba(0,0,0,0.18);border:none;text-align:left;width:calc(100% - 24px); }

...
<div class="root" style="background:{c.background};color:{c.textPrimary}">
  ...
  <div class="appbar" style="border-bottom:0.5px solid {c.divider}">
    ...
    <span class="appbar-title" style="color:{c.textPrimary}">Music</span>
    <div style="width:36px"></div>
  </div>

  <div class="placeholder">
    <img src="/icons/png/music.png" class="placeholder-icon" alt="Music" />
    <div class="placeholder-title" style="color:{c.textPrimary}">Music</div>

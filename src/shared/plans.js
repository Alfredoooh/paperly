...
export const ALL_APPS = [
  ...
  { id: 'drive', label: 'Nexa Drive', icon: '/icons/png/drive.png', path: '/drive/' },
  { id: 'calendar', label: 'Nexa Calendar', icon: '/icons/png/calendar.png', path: '/calendar/' },
  { id: 'chat', label: 'Nexa Chat', icon: '/icons/png/chat.png', path: '/chat/' },
  { id: 'tasks', label: 'Nexa Tasks', icon: '/icons/svg/tasks.svg', path: '/tasks/' },
  { id: 'notes', label: 'Nexa Notes', icon: '/icons/png/notes.png', path: '/notes/' },
  { id: 'forms', label: 'Nexa Forms', icon: '/icons/svg/forms.svg', path: '/forms/' },
  { id: 'projects', label: 'Nexa Projects', icon: '/icons/png/projects.png', path: '/projects/' },

<script>
  ...
  export let appTitle = 'Nexa Slides';
  export let appId = 'slides';
  export let iconPath = '/icons/svg/apps/slides.svg';
...
<style>
  ...
  .avatar { width:42px; height:42px; border-radius:10px; display:flex; align-items:center; justify-content:center; font-weight:700; color: var(--icon-strong); flex-shrink:0; }
